...
### GUI Menu (Recommended)

The easiest way to use this application is with the new **GUI Menu**. Simply run:

```bash
python main.py
```

A graphical menu will appear where you can:
1. **Select a year** (2018-2025)
2. **Browse and select a race** by name (e.g., "Australian Grand Prix")
3. **Choose session type** (Race, Qualifying, or Sprint)
4. **Click "Launch Replay"** to start the visualization

This is much easier than remembering round numbers!

### Command Line Arguments (Advanced)

For advanced users or automation, you can still use command-line arguments:
